<div class="event_sidebar" id="sticker">
    <ul>
        ...
        <li><a href="{{route('event-campaigns', ['id' => $event->id])}}" class="btn btn-lg {{(Route::current()->getName() == 'event-campaigns') ? 'btn-primary' : 'btn-default'}} btn-block">E-mails aux participants</a></li>
