...
var app = new Vue({
    ...
    methods: {
        addCampaign: function addCampaign(e) {
            e.preventDefault();
        ...
        initEditor: function initEditor() {
            ...
            $('.editor').trumbowyg({
                ...
                ['formatting'], ['strong', 'em', 'del'], ['superscript', 'subscript'], ['link'], ['insertImage'], ['justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull'], ['unorderedList', 'orderedList'], ['horizontalRule']],
                lang: 'fr'
            }).on('tbwblur', function () {
                self.$refs.message.value = $('.editor').trumbowyg('html');
            });
        },
        editCampaign: function editCampaign(id, event) {
...
jQuery.trumbowyg = {
    ...
    // SVG Path globally
    svgPath: '/storage/images/trumbowyg_icons.svg',
...
(function (navigator, window, document, $) {
    ...
    Trumbowyg.prototype = {
        ...
        destroy: function destroy() {
            ...
            if (t.isTextarea) {
                t.$box.after(t.$ta.css({ height: '' }).val(t.html()).removeClass(prefix + 'textarea').show());
            } else {
                t.$box.after(t.$ed.css({ height: '' }).removeClass(prefix + 'editor').removeAttr('contenteditable').removeAttr('dir').html(t.html()).show());
            }
